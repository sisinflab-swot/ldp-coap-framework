...
public class ServerMessageDeliverer implements MessageDeliverer {
	...
	protected final static Logger LOGGER = Logger.getLogger(ServerMessageDeliverer.class.getCanonicalName());
	 ...
	 */
	protected void checkForObserveOption(Exchange exchange, Resource resource) {
		Request request = exchange.getRequest();
